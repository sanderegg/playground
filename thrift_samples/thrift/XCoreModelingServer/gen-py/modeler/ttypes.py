...
class Entity(object):
    ...
    def __init__(self, name=None, uuid=None, children=None, has_geometry=True, pathNames=None, pathUuids=None, color=None,):
        self.name = name
        self.uuid = uuid
        self.children = children
        self.has_geometry = has_geometry
        self.pathNames = pathNames
        self.pathUuids = pathUuids
        self.color = color
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.pathNames = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRING:
                    self.pathUuids = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.STRUCT:
                    self.color = Color()
                    self.color.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.has_geometry is not None:
            ...
            oprot.writeFieldEnd()
        if self.pathNames is not None:
            oprot.writeFieldBegin('pathNames', TType.STRING, 5)
            oprot.writeString(self.pathNames.encode('utf-8') if sys.version_info[0] == 2 else self.pathNames)
            oprot.writeFieldEnd()
        if self.pathUuids is not None:
            oprot.writeFieldBegin('pathUuids', TType.STRING, 6)
            oprot.writeString(self.pathUuids.encode('utf-8') if sys.version_info[0] == 2 else self.pathUuids)
            oprot.writeFieldEnd()
        if self.color is not None:
            oprot.writeFieldBegin('color', TType.STRUCT, 7)
            self.color.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
Entity.thrift_spec = (
    ...
    (5, TType.STRING, 'pathNames', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'pathUuids', 'UTF8', None, ),  # 6
    (7, TType.STRUCT, 'color', [Color, None], None, ),  # 7
)
